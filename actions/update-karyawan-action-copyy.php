...
if($_POST){
    ...
    try{
        ...
        $query = "UPDATE karyawan 
                    SET nama=:nama, jabatan=:jabatan,id_dept=:departemen, tanggal_masuk=:tanggal_masuk, marital_status=:marital_status 
        ...
        if($stmt->execute()){
            ...
            echo "<script> alert('Record was updated'); window.location = '../admin/list-karyawan.php' </script>";
        }else{
            //echo "<div class='alert alert-danger'>Unable to update record. Please try again.</div>";
            echo "<script> alert('Unable to update record. Please try again.'); history.back(); </script>";
        }
